...
use crate::rpc::{Event, ResponseParamsSuccess, RpcResponsePayload, SessionDeleteRequest, SessionProposeRequest, SessionProposeResponse, SessionRequestRequest};
...
pub trait WalletProposalHandler: Send + Sync + 'static  {
  async fn verify_settlement(&self, _proposal: SessionProposeRequest, pk: String,
